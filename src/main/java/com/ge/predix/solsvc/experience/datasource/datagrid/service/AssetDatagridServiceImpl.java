...
public class AssetDatagridServiceImpl extends DatagridServiceImpl implements
	...
	private List<Column> getColumnData() {
		...
		Column column = new Column(
				"meter", "string", "text", new Double(25), "Meter Name"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column(
		...
		columns.add(column);
		column = new Column(
				"lastMeterReading", "string", "text", new Double(10), "Last Meter Reading"); //$NON-NLS-1$//$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
		columns.add(column);
		column = new Column(
